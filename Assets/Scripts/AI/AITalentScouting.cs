...
namespace RacingManager.AI
{
    ...
    public struct JuniorDriver
    {
        ...
        public List<Trait> Traits; // From AIDriverPace.cs
    }
    ...
    public class AITalentScouting : MonoBehaviour
    {
        ...
        public void AttemptToPoachGraduates(List<JuniorDriver> graduates, Team aiTeam, Team playerTeam)
        {
            ...
            foreach (var driver in graduates)
            {
                ...
                // A positive sum of trait modifiers and high potential makes a driver more attractive.
                float traitModifierSum = driver.Traits?.Sum(t => t.PaceModifier) ?? 0f;
                bool isInterested = driver.Potential > 50 && traitModifierSum >= 0;
